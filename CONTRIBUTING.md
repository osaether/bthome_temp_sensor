...
New files should use `SPDX-License-Identifier: Apache-2.0` unless their source
or provenance requires another license. Changes to an existing file remain
under the license identified by that file's SPDX header. In particular, the
files in `boards/` use `LicenseRef-Nordic-5-Clause`.

By submitting a contribution, you confirm that you have the right to submit it
under the applicable license. Preserve existing copyright and SPDX notices.
